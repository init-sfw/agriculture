 ...
 * @version 07/07/2009 
 */
public class ComparacionCostosAgroquimicosReportFrame extends ReportFrame
{
    ...
    public ComparacionCostosAgroquimicosReportFrame()
    {
        super();
    ...
    {
        return new ComparacionCostosAgroquimicosJasperReport()
        {
