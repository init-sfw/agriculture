...
/**
 * Clase PanelCostosSiembra
 *
 *
 * @author fbobbio
 * @version 09-dic-2009 
 */
public class PanelCostosSiembra extends PanelCostos
{
    /** Constructor por defecto de PanelCostosSiembra */
    public PanelCostosSiembra()
    {
        super();
    ...
    public void refreshUI()
    {
        try
        {
            GUIUtility.refreshComboBox(tipoCostoController.findCostosSiembra(), jComboBoxTipoCosto);
