 ...
 * @version 01-sep-2009 
 */
public class AgroquimicosPlanificadosReportFrame extends ReportFrame
{
    ...
    public AgroquimicosPlanificadosReportFrame()
    {
    ...
    {
        return new AgroquimicosPlanificadosJasperReport()
        {
